...
interval = 10
launcher = 'none'
load_from = 'D:\\mmdet_work_dirs\\widerface_rtmdet_tiny\\epoch_12.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file='widerface/annotations/widerface_val.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    proposal_nums=(
...
work_dir = 'D:\\mmdet_work_dirs\\widerface_rtmdet_tiny'
